...
// Colors
const BLUE = { r: 128, g: 0, b: 128 };
const GREEN = { r: 76, g: 125, b: 80 }; /*{ r: 0xa6, g: 0xe0, b: 0x2c };*/
const PINK = { r: 0xfa, g: 0x24, b: 0x73 };
const ORANGE = { r: 255, g: 253, b: 0 };
...
const touchTrailColor = 'rgba(170,221,255,.62)'; /*'rgba(170,221,255,.62)'*/
